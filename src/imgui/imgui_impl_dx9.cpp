...
//  [X] User texture binding. Use 'LPDIRECT3DTEXTURE9' as ImTextureID. Read
//  the FAQ about ImTextureID in imgui.cpp.

// You can copy and use unmodified imgui_impl_* files in your project. See
// main.cpp for an example of using this. If you use this binding you'll need
// to call 4 functions: ImGui_ImplXXXX_Init(), ImGui_ImplXXXX_NewFrame(),
// ImGui::Render() and ImGui_ImplXXXX_Shutdown(). If you are new to ImGui,
// see examples/README.txt and documentation at the top of imgui.cpp.
// https://github.com/ocornut/imgui

// CHANGELOG
// (minor and older changes stripped away, please see git history for
// details)
//  2018-05-07: Render: Saving/restoring Transform because they don't seem to
//  be included in the StateBlock. Setting shading mode to Gouraud.
//  2018-03-20: Misc: Setup io.BackendFlags ImGuiBackendFlags_HasMouseCursors
//  and ImGuiBackendFlags_HasSetMousePos flags + honor
//  ImGuiConfigFlags_NoMouseCursorChange flag. 2018-02-20: Inputs: Added
//  support for mouse cursors (ImGui::GetMouseCursor() value and WM_SETCURSOR
//  message handling). 2018-02-16: Misc: Obsoleted the io.RenderDrawListsFn
...
//  CreateContext/DestroyContext themselves. 2018-02-06: Inputs: Honoring the
//  io.WantSetMousePos by repositioning the mouse (when using navigation and
//  ImGuiConfigFlags_NavEnableSetMousePos is set). 2018-02-06: Inputs: Added
//  mapping for ImGuiKey_Space.
   ...
   for (int n = 0; n < draw_data->CmdListsCount; n++) {
      ...
      for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++) {
         ...
         if (pcmd->UserCallback) {
            ...
            g_pd3dDevice->DrawIndexedPrimitive(D3DPT_TRIANGLELIST, vtx_offset,
...
static bool ImGui_ImplDX9_CreateFontsTexture()
{
   ...
   if (g_pd3dDevice->CreateTexture(width, height, 1, 0, D3DFMT_A8R8G8B8,
                                   D3DPOOL_MANAGED, &g_FontTexture, NULL) < 0)
      return false;
...
void ImGui_ImplDX9_InvalidateDeviceObjects()
{
   ...
   // At this point note that we set ImGui::GetIO().Fonts->TexID to be ==
   // g_FontTexture, so clear both.
   ImGuiIO& io = ImGui::GetIO();
