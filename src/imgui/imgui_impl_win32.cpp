...
//  2018-01-05: Inputs: Added WM_LBUTTONDBLCLK double-click handlers for display classes with the CS_DBLCLKS flag.
...
void ImGui_ImplWin32_NewFrame()
{
   ...
   // Setup display size (every frame to accommodate for display resizing)
   RECT rect;
...
// PS: In this Win32 handler, we use the capture API (GetCapture/SetCapture/ReleaseCapture) to be able to read mouse coordinations when dragging mouse outside of our display bounds.
