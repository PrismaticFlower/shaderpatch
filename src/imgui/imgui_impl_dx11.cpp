...
void ImGui_ImplDX11_RenderDrawData(ImDrawData* draw_data)
{
   ...
   // Our visible imgui space lies from draw_data->DisplayPos (top left) to draw_data->DisplayPos+data_data->DisplaySize (bottom right). DisplayPos is (0,0) for single viewport apps.
   {
      ...
      if (device->Map(bd->pVertexConstantBuffer, 0, D3D11_MAP_WRITE_DISCARD, 0,
...
bool ImGui_ImplDX11_CreateDeviceObjects()
{
   ...
   // Create the vertex shader
   {
      ...
      if (bd->pd3dDevice->CreateVertexShader((DWORD*)imgui_impl_dx11_vs_shader,
   ...
   if (bd->pd3dDevice->CreateInputLayout(local_layout, 3, (DWORD*)imgui_impl_dx11_vs_shader,
                                         sizeof(imgui_impl_dx11_vs_shader),
   ...
   // Create the pixel shader
   {
      ...
      if (bd->pd3dDevice->CreatePixelShader((DWORD*)imgui_impl_dx11_ps_shader,
