...
void save_font(const std::string& output_dir, std::string& name,
...
void save_font(const std::string& output_dir, std::string& name, const Packed_font& packed)
{
